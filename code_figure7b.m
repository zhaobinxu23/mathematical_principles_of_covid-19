...
%% modeling individual behavior(strong immunity with d = 0.77) when infected with  29880bp virus .
num_c_valve = 0;
for kkk = 1: 500
    kkk

s(1,1)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,2)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,3)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,4)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,5)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,6)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,7)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,8)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,9)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,10)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,11)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,12)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,13)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,14)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,15)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,16)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,17)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,18)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,19)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
s(1,20)  = struct('length',29880,'replication_cycle',10,'waiting_time',0,'time',0);
...
matrix_d077n1len29880(input_number,kkk) = max(ddd);
clear ddd
end
end
save('matrix_for_figure7_29880','matrix_d077n1len29880')

model = matrix_d077n1len29900;
model2 = matrix_d077n1len29880;
yy(1) = 0;
zz(1) = 0;
for i = 1:20
    yy(i+1) = length(find(model(i,:)>=500))/500;
    zz(i+1) = length(find(model2(i,:)>=500))/500;
end
x = [0:1:20];
plot(x,yy);
hold on
